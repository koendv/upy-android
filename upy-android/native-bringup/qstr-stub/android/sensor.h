...
// actual NDK sensor API usage, so this only needs to satisfy the
...
#ifndef UPY_ANDROID_QSTR_STUB_ANDROID_SENSOR_H
#define UPY_ANDROID_QSTR_STUB_ANDROID_SENSOR_H
#endif
